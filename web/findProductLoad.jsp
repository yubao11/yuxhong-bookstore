...
/*
                        ...
                        <div class="grid_14">
                            ...
                            <div class="grid_3">
                                <p><%=sub_category_name %> <br/> <a href="admin_manageProduct.jsp?pid=<%= product_id %>" id="greenBtn">Edit</a><a style="margin-right: 10px;" href="addToCart.jsp?id=<%= product_id %>" id="greenBtn">加入购物车</a><p>将在3个工作日内送达</p>
                            </div>
                        </div>
                        <div class="clear"></div>
                        <%
